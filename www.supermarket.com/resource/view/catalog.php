...
include("app/Http/Controllers/CatalogController.php");

$catalog = new CatalogController;
$eloquent = new Eloquent;

if(!empty($_REQUEST['id']))
	$_SESSION['SMCH_catalog_page_id'] = $_REQUEST['id'];

# Loading Catalog Information using Custom Controller
$catalogInfo = $catalog->getCatalogInfo($_SESSION['SMCH_catalog_page_id']);

# Using Eloquent to Load Product List
$columnName = "*";
$tableName = "products";
$whereValue["product_status"] = "Active";
$whereValue["subcategory_id"] = $_SESSION['SMCH_catalog_page_id'];
            ...
            <div class="banner banner-cat" style="background-image: url('assets/images/banners/banner-top.jpg');">
                <div class="banner-content container">
                    ...
                    <h1 class="banner-title">
                        <?php echo $catalogInfo[0]['subcategory_name']; ?>
                    </h1>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#"><?php echo $catalogInfo[0]['category_name']; ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $catalogInfo[0]['subcategory_name']; ?></li>
                    </ol>
                </div><!-- End .container -->
            </nav>
							...
							<div class="product">
								...
								<div class="product-details">
									...
									<div class="product-action">
										...
										<a href="?p='.$eachProduct['id'].'&q=1" class="paction add-cart" title="Add to Cart">
