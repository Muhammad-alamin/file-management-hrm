                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="" enctype="multipart/form-data">
									<div class="form-group ">
                                        <label for="password" class="control-label col-lg-2">Category</label>
                                        <div class="col-lg-10">
                                            <select id="category_id" name="category_id" class="form-control m-bot15" required>
									...
									<div class="form-group ">
                                        <label for="subcategory_id" class="control-label col-lg-2">Subcategory</label>
                                        <div class="col-lg-10">
                                            <select id="subcategory_id" name="subcategory_id" class="form-control m-bot15" required>
                                ...
                                <div class="form-group last">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button name="product_create" class="btn btn-primary" type="submit">Submit</button>
...
$(document).ready(function () 
{
    $("#category_id").change(function () 
	{
        ...
        $.ajax({          
        	type: "GET",
        	url: "http://localhost:88/www.supermarket.com/admin/ajaxload.php",
