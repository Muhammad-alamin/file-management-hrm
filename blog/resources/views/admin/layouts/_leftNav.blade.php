    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview @if(request()->routeIs('file-management.index') || request()->routeIs('file-management.create') || request()->routeIs('file-management.edit')) menu-open @endif">
                    <a href="#" class="nav-link >
                        <i class="nav-icon fas fa-copy"></i>
                    <p>
                        File-Management
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('file-management.create')}}" class="nav-link @if(request()->routeIs('file-management.create')) active @endif ">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add New File</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('file-management.index')}}" class="nav-link @if(request()->routeIs('file-management.index')) active @endif " >
                            <i class="far fa-circle nav-icon"></i>
                            <p>File List</p>
                            </a>
                        </li>
