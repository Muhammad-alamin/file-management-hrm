        ...
        <footer class="footer-area bg-black" >
            <div class="footer-top footer-mrg"style="background:#4D5656;">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="footer-widget footer-logo text-center">
                                <a href="index.html"><img style="width: 120px; height: 100px;" src="files/logo/logo.png" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="footer-widget footer-social">
                                <a href="https://www.facebook.com/Monoroma-Collection-777837079028889/photos/?ref=page_internal"><i class="fa fa-facebook"></i></a>
            ...
            <div class="footer-bottom border-top-1 pt-15 pb-15"style="background:#4D5656;">
                <div class="container">
                    <div class="row">
